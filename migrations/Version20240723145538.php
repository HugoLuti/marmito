 ...
 */
final class Version20240723145538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recette CHANGE temps temps INT DEFAULT NULL, CHANGE description description VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recette CHANGE temps temps INT NOT NULL, CHANGE description description VARCHAR(255) DEFAULT NULL');
    }
}
